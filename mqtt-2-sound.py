...
def on_message(client, obj, msg):
    ...
    if msg.topic == 'door/inner/doorbell':
        ...
        time.sleep(1)
    elif msg.topic == 'tele/Garage/Gate' and msg.payload == 'STATE_ALARM':
        ...
        #play("audio/UnFoundBug/JumpVanHalen.ogg")
        time.sleep(1)
    elif msg.topic == 'tele/Garage/Courtyard' and msg.payload == 'STATE_ALARM':
        os.system("ogg123 -q audio/custom_dog_bark.ogg")
        #play("audio/buzzer.ogg")
        #play("audio/UnFoundBug/JumpVanHalen.ogg")
        time.sleep(1)
    elif msg.topic == 'tele/Garage/Door' and msg.payload == 'STATE_ALARM':
        os.system("ogg123 -q audio/ED209_Comply.mp3")
        #play("audio/buzzer.ogg")
        #play("audio/UnFoundBug/JumpVanHalen.ogg")
        time.sleep(1)        
    # elif msg.topic == 'tele/Garage/Door' and msg.payload == 'STATE_ALARM':
